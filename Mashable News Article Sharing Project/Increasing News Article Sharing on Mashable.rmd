...
```{r read_data, fig.show='hold', out.width = "50%", fig.align = "default"}
###################
###Data Cleaning###
###################
...
```{r clean_data, fig.show='hold', out.width = "50%", fig.align = "default"}
...
```{r clean_data_2, fig.show='hold', out.width = "50%", fig.align = "default"}
news <- dat0
...
```{r data_viz, fig.show='hold', out.width = "50%", fig.align = "default"}
########################
###Data Visualization###
########################
...
```{r PCA, fig.show='hold', out.width = "50%", fig.align = "default"}
#PCA
...
```{r K_means, echo = T, results = 'hide', message=FALSE, warning=FALSE, fig.show='hold', out.width = "50%", fig.align = "default"}
#K-mean clustering
...
```{r lm_interaction, echo = T, results = 'hide', message=FALSE, warning=FALSE}
...
```{r lm_step, echo = T, results = 'hide', message=FALSE, warning=FALSE}
#stepwise regression
...
```{r pca_model, fig.show='hold', out.width = "50%", fig.align = "default"}
#PCA
...
```{r CART, fig.show='hold', out.width = "50%", fig.align = "default"}
#CART
...
```{r lasso, fig.show='hold', out.width = "50%", fig.align = "default"}
#lasso
...
```{r post_lasso, fig.show='hold', out.width = "50%", fig.align = "default"}
#post lasso
...
```{r Evaluation, fig.show='hold', out.width = "50%", fig.align = "default"}
################
###Evaluation###
################
...
```{r Quantile_reg, message=FALSE, warning=FALSE, fig.show='hold', out.width = "50%", fig.align = "default"}
#########################
###Quantile Regression###
#########################
